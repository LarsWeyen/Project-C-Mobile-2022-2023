...
namespace Maui_Project_Lars_Weyen.Services
{
    public class GameService
    {
        ...
        {
            var content = new StringContent($"fields name,cover.image_id,videos.video_id,genres.name,game_modes.name,platforms.name,similar_games.name,similar_games.cover.image_id,rating;where id = {id};", Encoding.UTF8, "text/plain");
