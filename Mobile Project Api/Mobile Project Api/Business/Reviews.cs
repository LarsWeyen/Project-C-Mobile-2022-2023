...
namespace Mobile_Project_Api.Business
{
    public class Reviews
    {
        ...
        public static DataTable GetTrendingGamesDataTable()
        {
            var dv = new DataTable();
            try
            {
                var reviewData = new ReviewData();
                var result = reviewData.SelectTrendingGames();
                dv = result.DataTable;
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetReviewByReviewId(int reviewId)
        {
            var dv = new DataTable();
            try
            {
                var reviewData = new ReviewData();
                var result = reviewData.SelectReviewByReviewId(reviewId);
                dv = result.DataTable;
            }
            catch (Exception ex)
            {
